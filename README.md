...
> **Physics Specifics:** `AMPT` | `PYTHIA8` | `ROOT (CERN)` | `Geant4` | `Mathematica` | `HYDJET++` | `UrQMD` | `Matlab`
...
![Snake animation](https://raw.githubusercontent.com/dibakardhar/dibakardhar/output/github-contribution-grid-snake.svg)
